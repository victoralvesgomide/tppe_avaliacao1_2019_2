...
public class Aluno {
	...
	public Aluno(String nome, String prefixoMatricula, String sufixoMatricula, String email, String celular) throws DadosAlunoIncompletoException {
		if (nome == null || prefixoMatricula == null || sufixoMatricula == null ||
			...
			StringBuilder builder = formaMensagemExcecao(nome, prefixoMatricula, sufixoMatricula);
	...
	private StringBuilder formaMensagemExcecao(String nome, String prefixoMatricula, String sufixoMatricula) {
